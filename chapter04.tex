...
\paragraph{}
Vplyv výberu niektoré z vyššie uvedených spôsobov na kvalitu gramatiky a rýchlosť jej generovania potrebne skúmali v sekciách \label{sec:time} a \label{sec:pass}. Na základe týchto testov \[TODO\]
